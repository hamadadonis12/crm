               ...
               <div class="card">
                  <div class="card-body">
                     <div class="table-responsive">
                           ...
                           <tbody>
							@foreach($countries as $country)
                              <tr>
                                 ...
                                 <td>{{ $country->name }}</td>
								 <td>
								 	<a href="{{route('countries.edit', $country->id)}}" class="btn waves-effect waves-light btn-sm btn-info"><i class="mdi mdi-grease-pencil"></i> Edit</a>
						...
						<a href="{{route('countries.create')}}" class="btn btn-info btn-rounded m-t-10 float-left m-l-20">Add New</a>
                  </div>
               </div>
            </div>
         </div>				
