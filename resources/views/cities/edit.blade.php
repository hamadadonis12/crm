...
<div class="page-wrapper">
      <div class="container-fluid">
		...
		@endif
		{!! Form::model( $city, ['route' => ['cities.update', $city->id], 'method' => 'POST', 'files' => true ]) !!}
		@method('put')
		@csrf
        <div class="row">
			<div class="col-lg-9">
				<div class="card">
					...
					<div class="card-body">
						<div class="form-body">
							<h3 class="card-title">City General Info</h3>
							<hr>
				...
				<div class="card">
					...
					<div class="card-body">
						<div class="form-actions">
							...
							<a href="{{route('cities.index')}}" class="btn btn-inverse btn-width">Back</a>
						</div>
					</div>
				</div>
			</div>
