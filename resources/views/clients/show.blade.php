                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-5">
                        <div class="card">
                            ...
                            <div class="center-btn">
                                                             <a href="{{route('clients.edit', $client->id)}}" class="btn waves-effect waves-light btn-sm btn-info"><i class="fa fa-pencil-alt"></i> Edit</a>
								<form onsubmit="return confirm('Are you sure you want to delete?');" class="d-inline-block" method="post" action="{{route('clients.destroy', $client->id)}}">
									...
									@method('delete')
                                                             ...
                                                             <a href="{{route('clients.pdf', $client->id)}}" class="btn waves-effect waves-light btn-sm btn-primary"><i class="fa fa-id-card"></i> Generate Card</a>
							</div>
							<br>
							<!--<hr class="m-t-10"> 
                            <div class="card-body"> 
